...
public class OpenVpnManagementThread implements Runnable, OpenVPNManagement {
    ...
    {
        try {
            // ACC control-channel messages (AppCustomControl.kt in official
            // ics-openvpn) aren't ported here -- would need Kotlin added to
            // this build for a feature our servers don't send. Just log it.
            VpnStatus.logInfo("MGMT: received ACC message (not supported in this build): " + argument);
        } catch (Exception e) {
